...
const siteData$1 = JSON.parse('{"base":"/BBNext/","lang":"zh-CN","title":"BBNext","description":"这是我的第一个 VuePress 站点","head":[],"locales":{}}');
const pagesComponents = {
  // path: /
  "v-8daa1a0e": defineAsyncComponent(() => __vitePreload(() => import(
    /* webpackChunkName: "v-8daa1a0e" */
    "./index.html-d34f9c74.js"
  ), true ? ["assets/index.html-d34f9c74.js","assets/framework-5f17aa65.js"] : void 0)),
  // path: /404.html
  "v-3706649a": defineAsyncComponent(() => __vitePreload(() => import(
    /* webpackChunkName: "v-3706649a" */
    "./404.html-49bb10f7.js"
  ), true ? ["assets/404.html-49bb10f7.js","assets/framework-5f17aa65.js"] : void 0))
};
...
var withBase = (url) => {
  if (isLinkHttp(url))
    return url;
  return `${"/BBNext/"}${removeLeadingSlash(url)}`;
};
function r(r2, e, n) {
  var i, t, o;
...
var createVueRouter = () => {
  const router = createRouter({
    ...
    history: historyCreator(removeEndingSlash("/BBNext/")),
    routes: createRoutes(),
...
var createVueApp = async () => {
  ...
  {
    const { setupDevtools } = await __vitePreload(() => import("./setupDevtools-X4YFRK4B-652380a8.js"), true ? ["assets/setupDevtools-X4YFRK4B-652380a8.js","assets/framework-5f17aa65.js"] : void 0);
